...
import 'package:e_commerce_app/view/order_details_screen.dart';
    ...
    return Scaffold(
      ...
      body: Consumer<OrderProvider>(
        builder: (context, value, child) => Padding(
          ...
          child: value.orderDetails.isEmpty
              ? Center(
                  child: Column(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      const Image(
                        image: AssetImage('assets\\No orders.jpg'),
                      ),
                      SizedBox(
                      ...
                      Navigator.of(context).push(
                        MaterialPageRoute(
                          builder: (context) => OrderDetailsScreen(
                              ...
                              addresNmae:
                                  value.orderDetails[index].address.name,
                              fullAddress:
                              ...
                              expectedDate:
                                  value.orderDetails[index].expectedDate,
